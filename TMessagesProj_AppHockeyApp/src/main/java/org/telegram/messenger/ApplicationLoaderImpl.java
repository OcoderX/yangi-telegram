...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        ...
        // AyuGram: honor the "disable Crashlytics" option regardless of build flavor
        try {
            FirebaseCrashlytics.getInstance().setCrashlyticsCollectionEnabled(!AyuConfig.disableCrashlytics);
        } catch (Throwable e) {
            FileLog.e(e, false);
        }
        try {
            if (BuildVars.DEBUG_VERSION) {
                ...
                crashlytics.setCrashlyticsCollectionEnabled(!AyuConfig.disableCrashlytics);
            }
            if (BuildVars.DEBUG_VERSION) {
    ...
    protected void appCenterLogInternal(Throwable e) {
        if (AyuConfig.disableCrashlytics) {
            return;
        }
        try {
