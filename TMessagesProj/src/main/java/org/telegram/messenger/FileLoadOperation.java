...
//        FileLog.e("FileLoadOperation " + getFileName() + " setStream(" + stream + ")");
    ...
    private void updateParams() {
        if (SharedConfig.enableDownloadAccelerator && !forceSmallChunk) {
            ...
            maxDownloadRequests = SharedConfig.downloadThreadsCount;
            maxDownloadRequestsBig = SharedConfig.downloadThreadsCount;
            maxDownloadRequestsAnimation = SharedConfig.downloadThreadsCount;
