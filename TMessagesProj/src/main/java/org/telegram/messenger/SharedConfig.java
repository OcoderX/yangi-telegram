...
//    public static int saveToGalleryFlags;
    ...
    public static final int FONT_INTER = 1;
    public static final int FONT_JETBRAINS_MONO = 2;
    public static final int FONT_GOOGLE_SANS = 3;
    public static int selectedFontFamily = FONT_INTER;

    public static boolean enableMaterialYou = false;
    public static boolean enableGlassmorphism = true;
    public static int messageStatusStyle = 1;
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            selectedFontFamily = preferences.getInt("selectedFontFamily", FONT_INTER);
            enableMaterialYou = preferences.getBoolean("enableMaterialYou", false);
            enableGlassmorphism = preferences.getBoolean("enableGlassmorphism", true);
            messageStatusStyle = preferences.getInt("messageStatusStyle", 1);
    ...
    public static void setSelectedFontFamily(int fontFamily) {
        selectedFontFamily = fontFamily;
        AndroidUtilities.mediumTypeface = null;
        AndroidUtilities.clearTypefaceCache();
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("selectedFontFamily", selectedFontFamily);
        editor.apply();
    }
    ...
    public static void toggleMaterialYou() {
        ...
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("enableMaterialYou", enableMaterialYou);
        editor.apply();
    }

    public static void toggleGlassmorphism() {
        enableGlassmorphism = !enableGlassmorphism;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("enableGlassmorphism", enableGlassmorphism);
        editor.apply();
    }

    public static void setMessageStatusStyle(int style) {
        messageStatusStyle = style;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("messageStatusStyle", messageStatusStyle);
        editor.apply();
    }

    public static void toggleBottomNavigationFolders() {
        bottomNavigationFolders = !bottomNavigationFolders;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("bottomNavigationFolders", bottomNavigationFolders);
        editor.apply();
    }

    public static void toggleDownloadAccelerator() {
        enableDownloadAccelerator = !enableDownloadAccelerator;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("enableDownloadAccelerator", enableDownloadAccelerator);
        editor.apply();
    }

    public static void setDownloadThreadsCount(int count) {
        downloadThreadsCount = Math.max(4, Math.min(16, count));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
